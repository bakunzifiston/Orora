...
@section('content')
    ...
    @component('modules.partials.index-toolbar', ['filtersWide' => true])
        @slot('stats')
            <div class="dash-health-stats">
                ...
                <div class="dash-stat-card">
                    <div>
                        <div class="dash-stat-label">Lactating</div>
    ...
    @if ($animals->isEmpty())
        <div class="dash-panel dash-entity-empty">
            ...
            <p class="dash-empty">No animals registered yet.</p>
            <a href="{{ route('animals.create') }}" class="dash-btn-save">Register an animal</a>
        </div>
    @else
