...
<div class="animal-registration" data-animal-form>
    @component('modules.farms._form-section', [
        'number' => '1',
        'title' => __('Identity'),
        'description' => __('Core identification linked to a farm and livestock group.'),
        ...
        <div class="dash-form-grid">
            ...
            <div class="dash-form-field dash-form-field--full">
                <label for="livestock_id">{{ __('Livestock group') }} <span class="dash-required">*</span></label>
                <select name="livestock_id" id="livestock_id" required data-animal-livestock>
                    <option value="">{{ __('Select livestock group') }}</option>
                ...
                <p class="dash-field-hint">{{ __('Tag numbers must be unique within the selected livestock group.') }}</p>
            </div>
            <div class="dash-form-field">
                <label for="name">{{ __('Animal name') }} <span class="dash-required">*</span></label>
                <input type="text" name="name" id="name" value="{{ old('name', $animal?->name) }}" required>
            </div>
            <div class="dash-form-field">
                <label for="tag_number">{{ __('Tag number') }} <span class="dash-required">*</span></label>
                <input type="text" name="tag_number" id="tag_number" value="{{ old('tag_number', $animal?->tag_number) }}" required>
            </div>
            <div class="dash-form-field">
                <label for="gender">{{ __('Gender') }} <span class="dash-required">*</span></label>
            ...
            <div class="dash-form-field dash-form-field--full">
                ...
                <div class="dash-photo-field">
                    ...
                    <p class="dash-field-hint">{{ __('JPEG or PNG, max 2 MB. Leave empty to keep the current photo.') }}</p>
                </div>
            </div>
        </div>
    @endcomponent
    ...
    @component('modules.farms._form-section', [
        'number' => '2',
        'title' => __('Physical profile'),
        'description' => __('Birth date, weight, and visible characteristics.'),
        ...
        <div class="dash-form-grid">
            ...
            <div class="dash-form-field">
                <label for="age_display">{{ __('Age') }}</label>
                <input type="text" id="age_display" value="{{ $animal?->age_label }}" readonly placeholder="{{ __('Calculated from birth date') }}" data-age-display>
            </div>
            <div class="dash-form-field">
            ...
            <div class="dash-form-field">
                <label for="color_markings">{{ __('Color / markings') }}</label>
                <input type="text" name="color_markings" id="color_markings" value="{{ old('color_markings', $animal?->color_markings) }}" placeholder="{{ __('e.g. Black and white patches') }}">
            </div>
            <div class="dash-form-field">
    ...
    @component('modules.farms._form-section', [
        'number' => '3',
        'title' => __('Acquisition and lineage'),
        'description' => __('How the animal was acquired and parent tag references.'),
        ...
        <div class="dash-form-grid">
            ...
            <div class="dash-form-field">
                <label for="acquisition_date">{{ __('Acquisition date') }}</label>
            ...
            <div class="dash-form-field dash-form-field--full">
                ...
                <input type="text" name="source" id="source" value="{{ old('source', $animal?->source) }}" placeholder="{{ __('Seller, farm, or origin') }}">
            </div>
            <div class="dash-form-field">
                <label for="mother_tag">{{ __('Mother tag') }}</label>
                <input type="text" name="mother_tag" id="mother_tag" value="{{ old('mother_tag', $animal?->mother_tag) }}">
            </div>
            <div class="dash-form-field">
                <label for="father_tag">{{ __('Father tag') }}</label>
    ...
    @component('modules.farms._form-section', [
        'number' => '4',
        'title' => __('Status'),
        'description' => __('Health, production, lifecycle, and current condition.'),
