...
@section('content')
    @include('modules.partials.header', [
        'title' => __('Livestock'),
        'subtitle' => __('Herd and flock groups by farm with production and feeding details.'),
        ...
        @slot('stats')
            <div class="dash-health-stats">
                <div class="dash-stat-card">
                    <div>
                        <div class="dash-stat-label">{{ __('Total groups') }}</div>
                ...
                <div class="dash-stat-card">
                    <div>
                        <div class="dash-stat-label">{{ __('Total head count') }}</div>
