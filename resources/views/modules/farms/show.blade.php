...
@section('content')
    ...
    <div class="dash-page-header__actions" style="margin: -0.75rem 0 1.25rem; display: flex; gap: 0.75rem; flex-wrap: wrap;">
        ...
        <a href="{{ route('farms.edit', $farm) }}" class="dash-btn-save">Edit farm</a>
    </div>
    ...
    <div class="dash-health-grid">
        <div class="dash-panel">
            ...
            <dl class="dash-farm-detail">
                @include('modules.farms._detail-row', ['label' => 'Farm name', 'value' => $farm->name])
        ...
        <div class="dash-panel">
            <div class="dash-panel-title">Owner & contact</div>
            <dl class="dash-farm-detail">
                ...
                @else
                    ...
                    @include('modules.farms._detail-row', ['label' => 'Date of birth', 'value' => $farm->owner_dob?->format('M j, Y')])
                ...
                @include('modules.farms._detail-row', ['label' => 'Emergency', 'value' => $farm->owner_emergency_contact])
            </dl>
        </div>
    </div>
