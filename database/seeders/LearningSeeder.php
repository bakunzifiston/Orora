    ...
    public function run(): void
    {
        ...
        $posts = [
            [
                ...
                'title' => 'How to prevent mastitis in dairy cows',
                'slug' => 'prevent-mastitis-dairy-cows',
                'excerpt' => 'Expert advice on the most common disease affecting dairy farms and practical steps to reduce risk.',
                'content_type' => 'article',
                'content' => '<h2>Why mastitis matters</h2><p>Mastitis remains one of the most costly diseases on dairy farms. It lowers milk yield, reduces milk quality, and increases treatment costs.</p><h2>Milking hygiene</h2><p>Clean teats before and after milking, use individual towels, and replace liners on schedule.</p><h2>Early detection</h2><p>Check for clots, watery milk, or swollen quarters during every milking session. Log cases in Orora Farm to spot repeat offenders.</p><h2>Housing and nutrition</h2><p>Keep bedding dry, avoid overcrowding, and maintain balanced rations to support immune health.</p>',
                ...
                'views_count' => 1240,
                'tags' => ['mastitis', 'dairy', 'cattle', 'health'],
            ],
            [
                'category_id' => $map['animal-health'],
